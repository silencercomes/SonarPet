...
public class NMSImpl implements INMS {
    ...
    public void mount(Entity bukkitRider, Entity bukkitVehicle) {
        net.minecraft.server.v1_11_R1.Entity rider = ((CraftEntity) bukkitRider).getHandle();
        if (bukkitVehicle == null) {
            net.minecraft.server.v1_11_R1.Entity vehicle = rider.getVehicle(); // This is how you *really* get the vehicle :/
            ...
            net.minecraft.server.v1_11_R1.Entity vehicle = ((CraftEntity) bukkitVehicle).getHandle();
