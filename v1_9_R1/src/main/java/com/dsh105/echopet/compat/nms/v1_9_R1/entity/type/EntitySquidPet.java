...
public class EntitySquidPet extends EntitySquid implements EntityInsentientPet, IEntitySquidPet {
    ...
    @Override
    public CraftSquid getBukkitEntity() {
        return (CraftSquid) super.getBukkitEntity();
    }
