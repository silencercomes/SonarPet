...
public class EntitySpiderPet extends EntitySpider implements EntityInsentientPet, IEntitySpiderPet {
    ...
    @Override
    public CraftSpider getBukkitEntity() {
        return (CraftSpider) super.getBukkitEntity();
    }
